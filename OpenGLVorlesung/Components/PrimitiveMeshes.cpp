...
CPrimitiveMeshes CPrimitiveMeshes::GetCube()
{
	...
	CubeMesh.SetVertices({
		// Front
		Vertex{Vertex::Position{-0.5f, -0.5f, 0.5f}, Vertex::Color::Red(),   Vertex::Normal::One(),   Vertex::UVCoord{0.0f, 0.0f}}, // 0
		Vertex{Vertex::Position{0.5f, -0.5f, 0.5f},  Vertex::Color::Red(), Vertex::Normal::One(), Vertex::UVCoord{0.0f, 1.0f}}, // 1
		Vertex{Vertex::Position{-0.5f, 0.5f, 0.5f},  Vertex::Color::Red(),  Vertex::Normal::One(),  Vertex::UVCoord{1.0f, 0.0f}}, // 2
		Vertex{Vertex::Position{0.5f, 0.5f, 0.5f},   Vertex::Color::Red(), Vertex::Normal::One(), Vertex::UVCoord{1.0f, 1.0f}}, // 3

		// Right
		Vertex{Vertex::Position{0.5f, -0.5f, 0.5f},  Vertex::Color::Red(),   Vertex::Normal::One(),   Vertex::UVCoord{0.0f, 0.0f}}, // 4
		Vertex{Vertex::Position{0.5f, -0.5f, -0.5f}, Vertex::Color::Red(), Vertex::Normal::One(), Vertex::UVCoord{0.0f, 1.0f}}, // 5
		Vertex{Vertex::Position{0.5f, 0.5f, 0.5f},   Vertex::Color::Red(),  Vertex::Normal::One(),  Vertex::UVCoord{1.0f, 0.0f}}, // 6
		Vertex{Vertex::Position{0.5f, 0.5f, -0.5f},  Vertex::Color::Red(), Vertex::Normal::One(), Vertex::UVCoord{1.0f, 1.0f}}, // 7

		// Left
		Vertex{Vertex::Position{-0.5f, -0.5f, -0.5f},Vertex::Color::Red(),   Vertex::Normal::One(), Vertex::UVCoord{0.0f, 0.0f}}, // 8
		Vertex{Vertex::Position{-0.5f, -0.5f, 0.5f}, Vertex::Color::Red(), Vertex::Normal::One(), Vertex::UVCoord{0.0f, 1.0f}}, // 9
		Vertex{Vertex::Position{-0.5f, 0.5f, -0.5f}, Vertex::Color::Red(),  Vertex::Normal::One(), Vertex::UVCoord{1.0f, 0.0f}}, // 10
		Vertex{Vertex::Position{-0.5f, 0.5f, 0.5f},  Vertex::Color::Red(), Vertex::Normal::One(), Vertex::UVCoord{1.0f, 1.0f}}, // 11

		// Back
		Vertex{Vertex::Position{0.5f, -0.5f, -0.5f}, Vertex::Color::Red(),   Vertex::Normal::One(), Vertex::UVCoord{0.0f, 0.0f}}, // 12
		Vertex{Vertex::Position{-0.5f, -0.5f, -0.5f},Vertex::Color::Red(), Vertex::Normal::One(), Vertex::UVCoord{0.0f, 1.0f}}, // 13
		Vertex{Vertex::Position{0.5f, 0.5f, -0.5f},  Vertex::Color::Red(),  Vertex::Normal::One(), Vertex::UVCoord{1.0f, 0.0f}}, // 14
		Vertex{Vertex::Position{-0.5f, 0.5f, -0.5f}, Vertex::Color::Red(), Vertex::Normal::One(), Vertex::UVCoord{1.0f, 1.0f}}, // 15

		// Bottom
		Vertex{Vertex::Position{-0.5f, -0.5f, -0.5f},Vertex::Color::Red(),   Vertex::Normal::One(), Vertex::UVCoord{0.0f, 0.0f}}, // 16
		Vertex{Vertex::Position{0.5f, -0.5f, -0.5f}, Vertex::Color::Red(), Vertex::Normal::One(), Vertex::UVCoord{0.0f, 1.0f}}, // 17
		Vertex{Vertex::Position{-0.5f, -0.5f, 0.5f}, Vertex::Color::Red(),  Vertex::Normal::One(), Vertex::UVCoord{1.0f, 0.0f}}, // 18
		Vertex{Vertex::Position{0.5f, -0.5f, 0.5f},  Vertex::Color::Red(), Vertex::Normal::One(), Vertex::UVCoord{1.0f, 1.0f}}, // 19

		// Top
		Vertex{Vertex::Position{-0.5f, 0.5f, 0.5f},Vertex::Color::Red(),     Vertex::Normal::One(),Vertex::UVCoord{0.0f, 0.0f}}, // 20
		Vertex{Vertex::Position{0.5f, 0.5f, 0.5f}, Vertex::Color::Red(),   Vertex::Normal::One(),Vertex::UVCoord{0.0f, 1.0f}}, // 21
		Vertex{Vertex::Position{-0.5f, 0.5f, -0.5f}, Vertex::Color::Red(),  Vertex::Normal::One(),  Vertex::UVCoord{1.0f, 0.0f}}, // 22
		Vertex{Vertex::Position{0.5f, 0.5f, -0.5f},  Vertex::Color::Red(), Vertex::Normal::One(),Vertex::UVCoord{1.0f, 1.0f}}  // 23
		});
